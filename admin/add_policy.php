...
<body>
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="images/drive.png"  class="img-responsive">
      <div class="caption">
        <h3 align="center">Google 雲端硬碟</h3>
        <p>google提供的個人免費雲端空間，透過api存取<br><br></p>
        <p><a id="google_drive" class="btn btn-primary btn-block" role="button">使用这种方式</a></p>
      </div>
    </div>
  </div>
    <div class="col-sm-6 col-md-4">
    ...
    <div class="col-lg-3" align="right">
        <div class="sm" align="left">推荐开启，开启后系统会自动重命名文件。关闭也可，但重名文件无法上传</div>
           ...
           <a class="btn btn-lg btn-primary" onClick="save('qiniu');">保存更改</a>
                ...
                <form id="google_drive-f" style="display:none;">
                            <div class="row">
                           <div class="col-lg-2" align="right">
                            <label class="lab">上传方案名:</label>
                               </div>
                       ...
                       <div class="row">
                           <div class="col-lg-2" align="right">
                            <label class="lab">資料夾:</label>
                               </div>
                            <div class="col-lg-5" align="right">
                            <input type="text" name="kjm" class="form-control">
                               </div>
                               <div class="col-lg-3" align="right">
                           <div class="sm" align="left">資料夾ID</div>
                               </div>
                ...
                <div class="col-lg-2" align="right">
                 ...
                 <input type="text" name="kjurl" class="form-control">
                    ...
                    <div class="col-lg-3" align="right">
                <div class="sm" align="left">空间的URL <strong>只需填写主体部分，开头无需加“http://”，结尾无需加“/”</strong> 無特殊需求請輸入<?php echo $zzurl."includes/google_drive/view" ?></div>
                    </div>
              ...
              <div style="height:10px;"></div>
                       <div class="row">
                           <div class="col-lg-2" align="right">
                            <label class="lab">使用者授權碼:</label>
                               </div>
                            <div class="col-lg-5" align="right">
                            <input type="text"  name="ak"class="form-control">
                               </div>
                               <div class="col-lg-3" align="right">
                           <div class="sm" align="left">授權密鑰，按<a href="../includes/google_drive/getauth.php" target="_blank">這裡</a>取得</div>
                               </div>          
                       </div>
                       <div style="height:10px;"></div> 
                         <div class="row">
            ...
            <div style="height:10px;"></div>
                       ...
                       <div class="row">
                           <div class="col-lg-2" align="right">
                            ...
                            <div class="col-lg-5" align="left">
                      <a class="btn btn-lg btn-primary" onClick="save('google_drive');">保存更改</a>
                               </div>
                               <div class="col-lg-3" align="right">
